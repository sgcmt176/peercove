...
3. `docs/decisions.md` … 確定済みの技術判断(ADR-0001〜0006)。矛盾する実装をしないこと
...
- UDP ホールパンチング、直接通信(Phase 2 = roadmap トラック B。依頼者の着手判断待ち)
- UI、インストーラ、コード署名(M2 = roadmap トラック A。上位文書の要件確認待ち)
- macOS、モバイル、IPv6
